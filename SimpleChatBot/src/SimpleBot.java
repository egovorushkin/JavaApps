...
public class SimpleBot  {
    ...
    final String[] ELUSIVE_ANSWERS = {
            "Вопрос не простой, прошу тайм-аут для раздумья.",
            "Не уверен, что располагаю такой информацией.",
            "Может лучше поговорим о чет-то другом?",
    ...
    final Map<String, String> PATTERNS_FOR_ANALISYS = new HashMap<String, String>() { {
        //hello
        put("хай","hello");
        put("привет","hello");
        put("здорово","hello");
    ...
    final Map<String, String> ANSWERS_BY_PATTERNS = new HashMap<String, String>(){{
        ...
        put("whatdoyoudoing", "Я пробую общатья с людьми.");
    ...
    String sayInReturn(String msg, boolean ai){
        ...
        if (ai){
            ...
            for (Map.Entry<String, String> o : PATTERNS_FOR_ANALISYS.entrySet()){
